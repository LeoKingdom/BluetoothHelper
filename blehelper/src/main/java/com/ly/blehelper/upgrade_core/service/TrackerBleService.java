...
package com.ly.blehelper.upgrade_core.service;
...
import com.ly.blehelper.core.callbacks.WriteCallback;
import com.ly.blehelper.upgrade_core.ble_upgrade.annotation.ConfirmationType;
import com.ly.blehelper.upgrade_core.ble_upgrade.annotation.Enums;
import com.ly.blehelper.upgrade_core.ble_upgrade.annotation.MessageType;
import com.ly.blehelper.upgrade_core.ble_upgrade.annotation.State;
import com.ly.blehelper.upgrade_core.ble_upgrade.annotation.Support;
import com.ly.blehelper.upgrade_core.ble_upgrade.ble.BLEUtils;
import com.ly.blehelper.upgrade_core.ble_upgrade.ble.Characteristics;
import com.ly.blehelper.upgrade_core.ble_upgrade.ble.Services;
import com.ly.blehelper.upgrade_core.ble_upgrade.gaia.GaiaUpgradeManager;
import com.ly.blehelper.upgrade_core.ble_upgrade.receiver.BondStateReceiver;
import com.ly.blehelper.upgrade_core.ble_upgrade.rwcp.RWCPManager;
import com.ly.blehelper.upgrade_core.ble_upgrade.service.BLEService;
import com.ly.blehelper.upgrade_core.ble_upgrade.upgrade.UpgradeError;
import com.ly.blehelper.upgrade_core.ble_upgrade.upgrade.UploadProgress;
import com.ly.blehelper.upgrade_core.ble_upgrade.utils.Consts;
import com.ly.blehelper.upgrade_core.ble_upgrade.utils.Utils;
import com.ly.blehelper.upgrade_core.fota_upgrade.callbacks.DataCallback;
import com.ly.blehelper.upgrade_core.fota_upgrade.callbacks.NotifyCallback;
import com.ly.blehelper.upgrade_core.fota_upgrade.callbacks.ProgressCallback;
import com.ly.blehelper.upgrade_core.fota_upgrade.callbacks.U_NotifyOpenCallback;
import com.ly.blehelper.upgrade_core.fota_upgrade.callbacks.UpgradeStatusCallback;
import com.ly.blehelper.upgrade_core.fota_upgrade.helper.PetTrackerHelper;
import com.ly.blehelper.upgrade_core.fota_upgrade.utils.ActionUtils;
import com.ly.blehelper.upgrade_core.fota_upgrade.utils.DataPacketUtils;
import com.ly.blehelper.upgrade_core.fota_upgrade.utils.OrderSetUtils;
import com.ly.blehelper.upgrade_core.fota_upgrade.utils.TransformUtils;
import com.ly.blehelper.utils.SharePreferenceUtils;
...
//            toast("设备未连接");
        ...
        petTrackerHelper.setNotify(bleDevice, new U_NotifyOpenCallback() {
            @Override
