...
package com.ly.qcommesim.qcomm.widget;
...
public class VMUpgradeDialog extends DialogFragment {
     ...
     *
     * @param progress A progress object which contains the percentage of how many bytes of the file have been sent to
     ...
     *
     * @param message THe specific message to display.
     */
    ...
    private void init(View view) {
        mTVStep = (TextView) view.findViewById(R.id.tv_step_);
     ...
     *
     * @param listener The listener which will listen this dialog.
     */
    ...
    public interface UpgradeDialogListener {
         ...
         *
         * @return The actual resume point to display the step into the dialog.
         */
        @Enums
        int getResumePoint();
    }
