...
public class OrderSetUtils {
    ...
    public static final byte[] ESIM_PROFILE_DELETE = {(byte) 0xFD, 0, 0, 0, 0, 48, (byte) 0xA0}; //删除Profile指令
    public static final byte[] ESIM_PROFILE_DELETE_URL = {(byte) 0xFD, 0, 0, 0, 0, 48, (byte) 0xA1}; //删除Profile指令,回传url,tracker->app
    public static final byte[] ESIM_PROFILE_DELETE_POST = {(byte) 0xFD, 0, 0, 0, 0, 48, (byte) 0xA2}; //删除Profile指令,回传post data,tracker->app
    public static final byte[] ESIM_PROFILE_DELETE_RESPONSE = {(byte) 0xFD, 0, 0, 0, 0, 48, (byte) 0xA3}; //删除Profile指令,回复请求状态,app->tracker
